...
2. 의존성
    ...
    - 개발 의존성
        ...
        ${project-ex01} npm i -0 ......

3. 패키지 설치
    1) 전역(global) 설치 : 여러 프로젝트에서 공통으로 사용하는 도구 설치
    2) 지역(project local) 설치 : 적정 프로젝트에서 종속적인 도구나 라이브러리
    3) 패키지 설치
...
5. Module
    ...
    3) npm 모듈 : npm을 통해서 node_module에 설치하고 사용하는 모델
        - 원격 배포
        - 로컬 배포

6. nmpjs.com의 npm regitry에 패키지 배포(과제->자유임)

7. helloweb-ex01 : 웹애플리케이션 만들기(express framework x)
...
8. helloweb-ex02 : 웹애플리케이션 만들기(express framework o)
